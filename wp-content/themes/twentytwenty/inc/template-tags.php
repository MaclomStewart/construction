...
function twentytwenty_site_description( $echo = true ) {
    ...
    //Modified by metero 12/11/2020
//    $description = str_replace('&quot;','',$description);
//    $description = str_replace('&lt;','<',$description);
//    $description = str_replace('&gt;','>',$description);
    $description = '<span id="sub-title">株式会社</span>  <span id="main-title">'.esc_html($description).'</span><span id="area-life">くらし部</span>';

	$html = sprintf( $wrapper, $description);
