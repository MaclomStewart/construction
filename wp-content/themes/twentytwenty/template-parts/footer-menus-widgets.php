...
if ( $has_footer_menu || $has_social_menu || $has_sidebar_1 || $has_sidebar_2 ) {
    ...
    <div id="footer-social-wrapper">
        <a href="http://www.facebook.com"><img class="social-icon" id="footer-fb-ico" src="http://localhost/wordpress/wp-content/uploads/2020/12/facebook-ico.png"></a>
        <a href="http://www.instagram.com"><img class="social-icon" id="footer-inst-ico" src="http://localhost/wordpress/wp-content/uploads/2020/12/instagram-ico.png"></a>
    </div>
